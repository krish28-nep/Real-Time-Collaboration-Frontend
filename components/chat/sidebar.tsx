...
export function ChatSidebar({
  ...
  return (
    <>
      <aside className="flex min-h-screen flex-col justify-between border-r border-[#c7c4d8] bg-[#eff4ff] px-4 py-6 max-md:min-h-fit">
        <div>
          ...
          <div className="mb-2 flex items-center justify-between px-2">
            <p className="text-xs font-semibold uppercase text-[#77758a]">Channels</p>
            <button
              type="button"
              title="Create channel"
              aria-label="Create channel"
              onClick={onCreateChannelOpen}
              className="grid h-8 w-8 place-items-center rounded-lg text-[#3525cd] hover:bg-[#dce9ff]"
            >
          ...
          <nav className="flex flex-col gap-1">
            {channels.map((channel) => (
              <div
                key={channel.id}
                className={`group flex min-h-9 items-center gap-1 rounded-lg px-2 ${
              ...
              >
                <Link
                  ...
                  className="flex min-w-0 flex-1 items-center gap-3 py-2 text-left text-sm font-medium"
                >
                ...
                <button
                  ...
                  className="grid h-8 w-8 place-items-center rounded-lg opacity-80 hover:bg-white/70"
                >
                ...
                <button
                  ...
                  className="grid h-8 w-8 place-items-center rounded-lg text-[#cc2f4a] opacity-80 hover:bg-white/70 disabled:cursor-not-allowed disabled:opacity-40"
                >
        ...
        <div ref={profileMenuRef} className="relative flex flex-col gap-3 border-t border-[#c7c4d8] pt-6">
